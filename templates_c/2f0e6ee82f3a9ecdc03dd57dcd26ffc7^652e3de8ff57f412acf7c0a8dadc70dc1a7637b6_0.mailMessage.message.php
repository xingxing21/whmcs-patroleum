...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6289690bb49d20_28664474',
...
function content_6289690bb49d20_28664474 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <div style="max-width:600px;padding:20px 20px 0 20px">Patroleum</div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                ...
                                                &nbsp;<a href="https://patroleum.com/">https://patroleum.com/</a>
                                                <span class="hide-mobile"> | </span>
                                                <a href="https://patroleum.com/admin/">log in to the admin area</a>&nbsp;
                                            </td>
                                        </tr>
                                    </table>
                                </td>
