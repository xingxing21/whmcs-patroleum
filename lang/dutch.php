...
$_LANG['forwardingtogateway'] = "Even geduld aub, je wordt omgeleid naar de betaalmethode...";
...
$_LANG['marketConnect']['weebly']['ftpUsername'] = "FTP Gebruilersnaam";
$_LANG['marketConnect']['weebly']['ftpPassword'] = "FTP Wachtwoord";
$_LANG['marketConnect']['weebly']['ftpPath'] = "FTP Pad";
$_LANG['marketConnect']['weebly']['updateFtp'] = "FTP-referenties bijwerken";
$_LANG['marketConnect']['weebly']['manage'] = "Inloggen bij Weebly";
...
$_LANG['store']['ssl']['landingPage']['faq']['a5'] = "(EV) Extended Validation, is de hoogste klasse van SSL die vandaag de dag beschikbaar is en deze geeft meer geloofwaardigheid en vertrouwen aan een website dan andere SSL-certificaten. Ze bevatten functies zoals de groene adresbalk en de weergave van uw bedrijfsnaam. Hiervan is bewezen dat dit het consumentenvertrouwen vergroot.";
...
$_LANG['marketConnect']['spamexperts']['manageEmail'] = "Beheer uw e-mail";
...
$_LANG['marketConnect']['weebly']['buildWebsite'] = "Bouw uw website";
...
$_LANG['store']['addon']['wptk']['pleskIntroTitle'] = "Smart Updates for WordPress Toolkit identificeert en analyseert mogelijke updates voor uw WordPress installaties en voert vervolgens de update uit zonder risico voor uw live website of laat u weten dat er nu een potentieel gevaarlijke update beschikbaar is.";
