...
$_ADMINLANG['supportticketdepts']['pop3testconnection'] = "בדיקת החיבור";
...
$_ADMINLANG['supportticketdepts']['pop3oauthsetupinstructions']['Google'] = "<h1> מדריך ההתקנה של המאמת של גוגל  </h1> <p> 1. היכנס אל <a href=\"https://console.developers.google.com/\" target=\"_blank\"> מסוף המפתחים של גוגל </a>. </p> <p> 2. בחרו פרויקט קיים או צורו פרויקט חדש. </P> <p> 3. צורו אישורי התחברות באמצעות <i> כתובת האתר להפניה מחדש </i> המסופקת. </P> <p> 4. הזינו את <strong> מזהה הלקוח/סוד </strong> שנוצר עבורכם בשדות שסופקו. </P> <p> 5. לחצו על <strong> &quot; התחברות &quot; </strong> כדי ליצור את אסימון החיבור. </P> <p> 6. לחץצו על <strong> &quot; בדוק חיבור &quot; </strong> כדי לאמת את ההתקנה שלכם. </P>";
